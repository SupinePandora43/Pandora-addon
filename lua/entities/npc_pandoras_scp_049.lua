...
table.insert(spandora.scp.classes, "npc_pandoras_049")

list.Set( "NPC", "npc_pandoras_scp_049", {
	Name = "SCP - 049",
	Class = "npc_pandoras_scp_049",
...
if SERVER then
	...
	function ENT:ChaseEnemy(ops)
		...
		while (path:IsValid() and self:HaveEnemy()) do
			...
			path:Update( self )
			if(GetConVarNumber("pandora_debug")==1) then path:Draw() end
	...
	function ENT:Attack(ent)
		...
		local zombie = ents.Create("npc_pandoras_scp_049_2")
		zombie:SetPos(pos)

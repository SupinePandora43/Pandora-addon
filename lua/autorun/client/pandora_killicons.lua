...
killicon.AddAlias( "weapon_electromissle", "weapon_electrocannon" )--adding killicon to electromissle(electrocannon)
...
function PLAYER:ViewModelChanged(viewmodel, old, new)
    if new=="models/weapons/v_357.mdl" then
        killicon.AddFont( "weapon_tmrcolt", "HL2MPTypeDeath", "..", Color( 255, 80, 0, 255 ) )
    end
end
